package com.cn.yantu.interceptor;
 ...
 * 可插拔式的拦截器 要在spring-mvc.xml 配置interceptor
 * */ 
public class AuthorizationInterceptor  implements HandlerInterceptor {

	// 不拦截"/loginForm"和"/login"请求
	private static final String[] IGNORE_URI = {"/loginForm.do", "/login.do","/registerForm.do","/register.do"};
